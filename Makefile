...
mock:
	mockgen -package mockdb -destination db/mock/store.go github.com/sidizawi/simplebank/db/sqlc Store

.PHONY: postgres createdb startdb dropdb migrateup migratedown sqlc test server mock
